		...
		return bridge.minecraft.execute(
			{
				...
				regex: [
					{
						exp: RegExp(
							`^You invited (?:\\[.+?\\] )?(${user}) to your guild. They have 5 minutes to accept\\.$`,
							"i",
						),
						exec: ([, username]) =>
							interaction.editReply({
								embeds: [
									SimpleEmbed(
										"success",
										`${inlineCode(username)} has been invited to the guild`,
									),
								],
							}),
					},
					{
						exp: RegExp(
							`^You sent an offline invite to (?:\\[.+?\\] )?(${user})! They will have 5 minutes to accept once they come online!$`,
							"i",
						),
						exec: ([, username]) =>
							interaction.editReply({
								embeds: [
									SimpleEmbed(
										"success",
										`${inlineCode(username)} has been offline invited to the guild`,
									),
								],
							}),
					},
						...
						exec: ([, username]) =>
							interaction.editReply({
								embeds: [
									SimpleEmbed(
										"failure",
										`${inlineCode(username)} is in another guild`,
									),
								],
							}),
					},
					{
						exp: RegExp(
							`^You've already invited (?:\\[.+?\\] )?(${user}) to your guild. Wait for them to accept!$`,
							"i",
						),
						exec: ([, username]) =>
							interaction.editReply({
								embeds: [
									SimpleEmbed(
										"failure",
										`${inlineCode(username)} already has a pending guild invite`,
									),
								],
							}),
					},
						...
						exec: ([, username]) =>
							interaction.editReply({
								embeds: [
									SimpleEmbed(
										"failure",
										`${inlineCode(username)} is already in the guild`,
									),
								],
							}),
					},
					{
						...
						exec: () =>
							interaction.editReply({
								embeds: [SimpleEmbed("failure", "The guild is full")],
							}),
					},
					{
						...
						exec: () =>
							interaction.editReply({
								embeds: [
									SimpleEmbed(
										"failure",
										`${inlineCode(user)} has guild invites disabled`,
									),
								],
							}),
					},
